...
model = load_model('C:\\Users\\ankit\\Documents\\modular_code\\output\\Final_kmeans_model')
...
def run():
    ...
    ## loading an image
    image = Image.open('C:\\Users\\ankit\\Documents\\modular_code\\input\\customer_segmentation.png')
